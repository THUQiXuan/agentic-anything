...
This `document` pack is a structured capture of https://github.com/THUQiXuan/agentic-anything/blob/main/demos/sources/operations-handbook.md made on 2026-07-11T00:00:00Z in `ingest` mode. It contains 4 evidence unit(s), an interface inventory, and markdown views an agent can read directly.
