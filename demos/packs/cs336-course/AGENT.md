# Stanford CS336 | Language Modeling from Scratch (2025) — Resource Agent

This **Agentic Anything** resource agent wraps a `web` source as an
agent-native pack with 8 captured evidence units.
