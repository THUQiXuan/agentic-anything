---
name: fair-paper
description: Agent-native resource pack for https://pmc.ncbi.nlm.nih.gov/articles/PMC4792175/ (1 units captured; generated without LLM).
---
...
This `document` pack is a structured capture of https://pmc.ncbi.nlm.nih.gov/articles/PMC4792175/ made on 2026-07-11T00:00:00Z in `ingest` mode. It contains 1 evidence unit(s), an interface inventory, and markdown views an agent can read directly.

## Resource map

| page_id | type | title |
|---|---|---|
| `fair-guiding-principles-pmc4792175` | page | The FAIR Guiding Principles for scientific data management… |
...
cat pages/fair-guiding-principles-pmc4792175.md
