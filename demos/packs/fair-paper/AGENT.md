# The FAIR Guiding Principles for scientific data management and stewardship - PMC — Resource Agent

This **Agentic Anything** resource agent wraps a `document` source as an
